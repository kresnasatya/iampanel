        ...
        <div class="w-full">
            <div class="flex flex-col space-y-4 md:grid md:grid-cols-2 md:gap-4" x-data="{ showPassword: false, showPasswordConfirmation: false }">
                ...
                <label class="block mt-4">
                    <span class="text-gray-700 dark:text-gray-400 @error('password') text-red-500 @enderror text-sm">Kata sandi baru</span>
                    <div class="relative">
                        <input :type="showPassword ? 'text' : 'password'" wire:model.defer="password" class="block w-full mt-1 rounded-md shadow-sm text-sm border-gray-300 @error('password') border-red-500 @enderror dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:outline-none focus:ring focus:ring-blue-400" placeholder="Kata sandi baru">
                ...
                <label class="block mt-4">
                    <span class="text-gray-700 dark:text-gray-400 @error('password') text-red-500 @enderror text-sm">Konfirmasi kata sandi baru</span>
                    <div class="relative">
                        <input :type="showPasswordConfirmation ? 'text' : 'password'" wire:model.defer="password_confirmation" class="block w-full mt-1 rounded-md shadow-sm text-sm border-gray-300 @error('password') border-red-500 @enderror dark:border-gray-600 dark:bg-gray-700 dark:text-gray-300 focus:outline-none focus:ring focus:ring-blue-400" placeholder="Konfirmasi kata sandi baru">
