                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3">
                                    <div class="flex items-center space-x-4 text-sm">
                                        <button title="Tambah akses pengguna" wire:key="user-profile-{{ $user['id'] }}" wire:click="addUserToClientRole('{{ $user['id'] }}', '{{ $user['lastName'] }}')" class="flex items-center justify-between px-2 py-2 text-sm font-medium leading-5 text-blue-600 rounded-lg dark:text-gray-400 focus-control">
